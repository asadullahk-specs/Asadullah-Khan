    ...
    <header className="sticky top-0 z-50 backdrop-blur bg-lightCard/90 dark:bg-darkSecondary/90 border-b border-gray-200 dark:border-gray-800">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button onClick={() => setMobileOpen(true)} aria-label="Open menu" className="md:hidden p-2.5 rounded-lg bg-accent/10 hover:bg-accent/20 text-accent shrink-0">
            <Menu size={24} />
          </button>
        </div>
      </nav>
        ...
        {mobileOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed top-0 right-0 h-full w-[82%] max-w-80 bg-lightCard dark:bg-darkSecondary z-50 p-6 md:hidden shadow-2xl flex flex-col"
            >
