...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-gray-200 dark:border-gray-800 bg-lightCard dark:bg-darkSecondary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-6 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-8 sm:gap-x-8">
        <div className="col-span-2 lg:col-span-1 flex flex-col items-start text-left">
          <h3 className="heading text-lg mb-3">Want to Connect With Me?</h3>
        ...
        <div className="col-span-1 flex flex-col items-start text-left pt-6 lg:pt-0 border-t border-gray-200 dark:border-gray-800 lg:border-t-0">
        ...
        <div className="col-span-2 lg:col-span-1 flex flex-col items-start text-left pt-6 border-t border-gray-200 dark:border-gray-800 lg:border-t-0 lg:pt-0">
          <h3 className="heading text-sm mb-3 tracking-wider">CONTACT</h3>
          <ul className="space-y-2 text-sm">
            <li className="flex items-center gap-2 justify-start"><Phone size={14} className="text-accent shrink-0" /> {contact.adminPhone}</li>
            <li className="flex items-center gap-2 justify-start"><Mail size={14} className="text-accent shrink-0" /> {contact.adminEmail}</li>
            <li className="flex items-center gap-2 justify-start"><MapPin size={14} className="text-accent shrink-0" /> {contact.adminLocation}</li>
          </ul>
        </div>
      </div>
